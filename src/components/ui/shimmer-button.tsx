    ...
    return (
      <button
        ...
        className={cn(
          ...
          'transform-gpu transition-transform duration-300 ease-in-out active:translate-y-px disabled:cursor-not-allowed disabled:opacity-40',
          className,
        )}
        ref={ref}
        {...props}
      >
        ...
        <div
          className={cn(
            'absolute inset-0 size-full rounded-2xl shadow-[inset_0_-8px_10px_#ffffff1f]',
